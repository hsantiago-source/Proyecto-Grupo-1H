...
public class LectorCSV {
    ...
    public void leerDiccionarioHash (String rutaArchivo) {
        ...
        try {
            ...
            while ((linea = br.readLine()) != null) {
                if (linea.isBlank() || linea.toLowerCase().contains("id,nombre")) continue;                
    ...
    public void leerRedNeuronal(String rutaArchivo) {
        ...
        try {
            ...
            while ((linea = br.readLine()) != null) {
                if (linea.isBlank() || linea.toLowerCase().contains("origen")) continue;
